...
j = sqrt(-1);
stableRealPlantPoles = [0.5];
%stableComplexPlantPoles = [0.25+0.25*j 0.25-0.25*j];
stableComplexPlantPoles = [];
%unstablePlantPoles = [-2];
unstablePlantPoles = []; % <-- FIX 1: Defined this as empty so it doesn't cause an error
...
realWPoles = [];
complexWPoles = [0.4+0.4*j 0.4-0.4*j];
