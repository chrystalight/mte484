...
% POLE_THRESH = 100;
% sorted_poleset = sortrows(working_poleset, 4, 'descend');
% this_poleSet = sortrows(sorted_poleset(1:96, :), 1, 'ascend');
% poleset = complex(this_poleSet(:, 2), this_poleSet(:, 3));
% poleset = complex(working_poleset(:, 2), working_poleset(:, 3));
poleset = complex(final_poleset(:, 2), final_poleset(:, 3));
%poleset = prune_1.';
